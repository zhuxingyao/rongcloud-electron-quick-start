 ...
 * Tue Feb 08 2022 14:33:04 GMT+0800 (中国标准时间)
...
`;
    ...
    */
    ...
    (function (Topic) {
        ...
        Topic[Topic["pmcMsgN"] = 7] = "pmcMsgN";
        Topic[Topic["qryPMsg"] = 8] = "qryPMsg";
        Topic[Topic["qryGMsg"] = 9] = "qryGMsg";
        Topic[Topic["qryCHMsg"] = 10] = "qryCHMsg";
        Topic[Topic["qryCMsg"] = 11] = "qryCMsg";
        Topic[Topic["qrySMsg"] = 12] = "qrySMsg";
        Topic[Topic["recallMsg"] = 13] = "recallMsg";
        Topic[Topic["prMsgS"] = 14] = "prMsgS";
        /** 发送已读回执 */
        Topic[Topic["rrMsg"] = 15] = "rrMsg";
        /** 获取已读列表 */
        Topic[Topic["rrList"] = 16] = "rrList";
        /** 消息通知拉取 */
        Topic[Topic["s_ntf"] = 17] = "s_ntf";
        /** 服务直发消息 */
        Topic[Topic["s_msg"] = 18] = "s_msg";
        /**
         * 状态同步
         * @todo 需确定同步哪些状态
         */
        Topic[Topic["s_stat"] = 19] = "s_stat";
        /** 服务端通知：聊天室 kv 、会话状态 */
        Topic[Topic["s_cmd"] = 20] = "s_cmd";
        /** 实时配置变更通知 */
        Topic[Topic["s_us"] = 21] = "s_us";
        /** 拉取实时配置 */
        Topic[Topic["pullUS"] = 22] = "pullUS";
        Topic[Topic["pgMsgS"] = 23] = "pgMsgS";
        Topic[Topic["chatMsgS"] = 24] = "chatMsgS";
        Topic[Topic["qrySessionsAtt"] = 25] = "qrySessionsAtt";
        Topic[Topic["pullMsg"] = 26] = "pullMsg";
        Topic[Topic["qrySessions"] = 27] = "qrySessions";
        Topic[Topic["delSessions"] = 28] = "delSessions";
        Topic[Topic["delMsg"] = 29] = "delMsg";
        Topic[Topic["updRRTime"] = 30] = "updRRTime";
        /** 拉取聊天室消息 */
        Topic[Topic["chrmPull"] = 31] = "chrmPull";
        Topic[Topic["joinChrm"] = 32] = "joinChrm";
        Topic[Topic["joinChrmR"] = 33] = "joinChrmR";
        Topic[Topic["exitChrm"] = 34] = "exitChrm";
        Topic[Topic["queryChrmI"] = 35] = "queryChrmI";
        Topic[Topic["setKV"] = 36] = "setKV";
        Topic[Topic["delKV"] = 37] = "delKV";
        /** 拉取聊天室 KV 存储 */
        Topic[Topic["pullKV"] = 38] = "pullKV";
        Topic[Topic["qryRelation"] = 39] = "qryRelation";
        Topic[Topic["delRelation"] = 40] = "delRelation";
        Topic[Topic["pullSeAtts"] = 41] = "pullSeAtts";
        Topic[Topic["setSeAtt"] = 42] = "setSeAtt";
        Topic[Topic["qnTkn"] = 43] = "qnTkn";
        Topic[Topic["qnUrl"] = 44] = "qnUrl";
        Topic[Topic["aliUrl"] = 45] = "aliUrl";
        Topic[Topic["s3Url"] = 46] = "s3Url";
        Topic[Topic["stcUrl"] = 47] = "stcUrl";
        Topic[Topic["cleanPMsg"] = 48] = "cleanPMsg";
        Topic[Topic["cleanGMsg"] = 49] = "cleanGMsg";
        Topic[Topic["cleanCMsg"] = 50] = "cleanCMsg";
        Topic[Topic["cleanSMsg"] = 51] = "cleanSMsg";
        Topic[Topic["rtcRJoin_data"] = 52] = "rtcRJoin_data";
        Topic[Topic["rtcRExit"] = 53] = "rtcRExit";
        Topic[Topic["rtcPing"] = 54] = "rtcPing";
        Topic[Topic["rtcSetData"] = 55] = "rtcSetData";
        Topic[Topic["rtc_ntf"] = 56] = "rtc_ntf";
        Topic[Topic["viewerJoinR"] = 57] = "viewerJoinR";
        Topic[Topic["viewerExitR"] = 58] = "viewerExitR";
        Topic[Topic["rtcPullKv"] = 59] = "rtcPullKv";
        Topic[Topic["rtcIdentityChange"] = 60] = "rtcIdentityChange";
        /** 全量 URI 资源变更 */
        Topic[Topic["userSetData"] = 61] = "userSetData";
        Topic[Topic["rtcQryData"] = 62] = "rtcQryData";
        Topic[Topic["rtcDelData"] = 63] = "rtcDelData";
        Topic[Topic["rtcSetOutData"] = 64] = "rtcSetOutData";
        Topic[Topic["rtcQryUserOutData"] = 65] = "rtcQryUserOutData";
        Topic[Topic["rtcToken"] = 66] = "rtcToken";
        Topic[Topic["rtcUserState"] = 67] = "rtcUserState";
        Topic[Topic["rtcRInfo"] = 68] = "rtcRInfo";
        Topic[Topic["rtcUData"] = 69] = "rtcUData";
        Topic[Topic["rtcUPut"] = 70] = "rtcUPut";
        Topic[Topic["rtcUDel"] = 71] = "rtcUDel";
        Topic[Topic["rtcUList"] = 72] = "rtcUList";
    ...
    const validHosts = (hosts, protocol, runtime, onStepCallback) => __awaiter(void 0, void 0, void 0, function* () {
        let num = 0;
        hosts.forEach((host) => __awaiter(void 0, void 0, void 0, function* () {
            const url = `${protocol}://${host}/ping?r=${randomNum(1000, 9999)}`;
            logger.debug('start ping', url);
            const res = yield runtime.httpReq({
                url,
                timeout: PING_REQ_TIMEOUT
            });
            logger.debug('end ping', num, url, res.status);
            num++;
            // 这里加 null 是为了解决 eslint 报错
            onStepCallback({
                finished: num === hosts.length,
                code: res.status,
                host
            });
        }));
    ...
    class WebSocketChannel extends ADataChannel {
        ...
        connect(appkey, token, hosts, protocol, apiVersion) {
            return __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve) => {
                    ...
                    const loopConnect = () => __awaiter(this, void 0, void 0, function* () {
                        if (_hosts.length === 0 || isConnecting) {
                            return;
                        }
                        isConnecting = true;
                        const code = yield this._connect(appkey, token, _hosts.shift(), protocol, apiVersion);
                        if (code === ErrorCode$1.SUCCESS) {
                            ...
                            if (pingFinished && _hosts.length === 0) {
                                // 全部连接失败，错误出口
                    ...
                    // 发起 ping 请求
                    validHosts(hosts, protocol, this._runtime, ({ code, finished, host }) => {
                        pingFinished = finished;
                        if (code === 200) {
                            _hosts.push(host);
                            pingSuccessCount++;
                            loopConnect();
                        }
                        if (finished && pingSuccessCount === 0) {
                            // 全部 ping 失败，错误出口
                            logger.error('No valid websocket server hosts!');
                            resolve(ErrorCode$1.RC_SOCKET_NOT_CREATED);
                        }
                    });
                });
            });
         ...
         * 发起连接请求
         */
        _connect(appkey, token, host, protocol, apiVersion) {
            return __awaiter(this, void 0, void 0, function* () {
                const wsProtocol = protocol.replace('http', 'ws');
                const url = formatWSUrl(wsProtocol, host, appkey, token, this._runtime, apiVersion);
                ...
                const code = yield new Promise((resolve) => {
                    ...
                    socket.onClose((code, reason) => {
                        ...
                        // 断开连接时将所有的异步拉取结束掉
                        for (const key in this._messageIds) {
                            const _resolve = this._messageIds[key];
    ...
    class CometChannel extends ADataChannel {
        ...
        _connect(appkey, token, host, protocol, apiVersion) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const url = formatWSUrl(protocol, host, appkey, token, this._runtime, apiVersion, this._pid);
                this.sendConnectTime = Date.now();
                logger.debug(`conenct start -> ${url}`);
                const res = yield this._runtime.httpReq({
                    url,
    ...
    class Letterbox {
        ...
        _getMemData(userId) {
            return this._users[userId] || (this._users[userId] = { inboxTime: 0, outboxTime: 0 });
        }
        /**
         * 更新收件箱时间
         * @param timestamp
        ...
        setInboxTime(timestamp, userId) {
            const data = this._getMemData(userId);
    ...
    */
    ...
    class ConversationManager {
        ...
        */
        _calcUnreadCount(message, localConversation) {
            ...
            if (hasBeenAdded || isSelfSend) {
                return { hasChanged, localConversation, updateItems };
            }
            // 计数的消息，未读数 + 1
            if (isCounted) {
        ...
        */
        _calcMentionedInfo(message, localConversation) {
            const { content, messageDirection, isMentioned, sentTime } = message;
            messageDirection === MessageDirection$1.SEND;
            const hasContent = isObject(content);
            let hasChanged = false;
            const updateItems = {};
        ...
        */
        setConversationCacheByMessage(message, isPullMessageFinished) {
            ...
            CalcEvents.forEach((func) => {
                const { hasChanged: hasCaclChanged, localConversation, updateItems } = func.call(this, message, storageConversation);
                hasChanged = hasChanged || hasCaclChanged;
                _updateItems = Object.assign(Object.assign({}, _updateItems), updateItems);
            ...
            if (isPersited) {
                ...
                conversation.updatedItems = Object.assign({ latestMessage: {
        ...
        */
         ...
         * 清除本地指定会话未读数
        */
        clearUnreadCount(conversationType, targetId, isNotify = true) {
            const conversation = this._store.get(conversationType, targetId);
            ...
            if (Object.keys(updatedItems).length === 0)
                return;
            const updateConOptions = Object.assign(conversation, { conversationType, targetId, updatedItems });
            this._setUpdatedConversation(updateConOptions);
            this._notifyConversationChanged();
        }
        /**
        ...
        clearAllUnreadCount() {
            ...
            conversationList.forEach(conversation => {
                if (conversation.unreadMessageCount) {
                    conversation.unreadMessageCount = 0;
                    this._store.set(conversation.conversationType, conversation.targetId, conversation);
                }
            });
        }
        ...
        getInfo(token, dynamicUris, force) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!this._runtime.useNavi) {
                    this._miniConnectUrl = ((_a = this._options.miniCMPProxy) === null || _a === void 0 ? void 0 : _a.length) ? this._options.miniCMPProxy.join(',') : '';
                    dynamicUris = [];
                }
    ...
    const getPubTopic = (type) => {
        return {
            ...
            [ConversationType$1.APP_PUBLIC_SERVICE]: Topic$1.pmcMsgN
        }[type];
    };
    ...
    */
    ...
    class JSEngine extends AEngine {
        ...
        */
        ...
        clearConversationUnreadCount(conversationType, targetId) {
            this._conversationManager.clearUnreadCount(conversationType, targetId, false);
    ...
    class APIContext {
        constructor(_runtime, options) {
             ...
             */
            this.coreVersion = "4.4.8-enterprise.2";
            this._versionInfo = {};
            this._typingInfo = {};
            /**
            ...
            if (this._options.navigators.length === 0 && !true) {
        ...
        static init(runtime, options) {
            ...
            logger.warn('RCEngine Commit:', "bbd1ce6836028953773821c2b3b9ab8199bc732f");
     ...
     * engine 版本号
     */
    const version = "4.4.8-enterprise.2";
...
/*
 * RongIMLib - v2.9.8-enterprise.2
 * CommitId - 509020a04ffdd66eac24a9ccb9e26b146ee66af0
 * Tue Feb 08 2022 14:35:17 GMT+0800 (中国标准时间)
 * ©2020 RongCloud, Inc. All rights reserved.
 */
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getKey(conversationType, targetId, channelId) {
        return conversationType + '_' + targetId + '_' + channelId;
    }
    /**
     * 本地维护最后一条消息，解决发送消息后获取会话列表时最后一条消息未更新的问题
     */
    class LatestMessageMap {
        static set(message) {
            // 非存储消息直接返回
            if (!engine.SEND_MESSAGE_TYPE_OPTION[message.messageType] || !engine.SEND_MESSAGE_TYPE_OPTION[message.messageType].isPersited) {
                return;
            }
            const localMessage = LatestMessageMap.get(message.conversationType, message.targetId, message.channelId || '');
            if (!localMessage || localMessage.sentTime < message.sentTime) {
                const key = getKey(message.conversationType, message.targetId, message.channelId || '');
                LatestMessageMap.map[key] = message;
            }
        }
        static get(conversationType, targetId, channelId) {
            const key = getKey(conversationType, targetId, channelId);
            return LatestMessageMap.map[key] || null;
        }
        static remove(conversationType, targetId, channelId) {
            const key = getKey(conversationType, targetId, channelId);
            delete LatestMessageMap.map[key];
        }
        static clear() {
            LatestMessageMap.map = {};
        }
    }
    LatestMessageMap.map = {};
    ...
    const MsgTypeMapping = {
        ...
        'RC:RRMsg': 'GroupReadReceiptResponseMessage'
    };
    ...
    */
    function tranToV2Conversation(conversation) {
        let { channelId, conversationType, targetId, unreadMessageCount, latestMessage, isTop, notificationStatus, matchCount } = conversation;
        // 在浏览器平台用本地缓存中的 LatestMessageMap 消息覆盖 latestMessage
        if (!engine.usingCppEngine()) {
            const message = LatestMessageMap.get(conversationType, targetId, channelId || '');
            if (!latestMessage) {
                latestMessage = message;
            }
            else if (message && latestMessage.sentTime < message.sentTime) {
                latestMessage = message;
            }
        }
    ...
    */
    function tranToV2Message(message) {
        let { conversationType, targetId, senderUserId, content, messageType, messageUId, messageDirection, isOffLineMessage: offLineMessage, sentTime, receivedStatus, receivedTime, canIncludeExpansion, disableNotification, expansion, messageId, sentStatus, channelId, readReceiptInfo, pushConfig } = message;
     ...
     * 处理群回执请求消息本地存储
    */
    function handleRRReqMsg(message, currentUserId, connectTime, readReceiptTimeout) {
        const date = new Date(connectTime - readReceiptTimeout * 1000 * 60 * 60 * 24).getTime();
        // new Date(date).getTime() - message.sentTime < 1 逻辑判断 超过 1 天未收的 ReadReceiptRequestMessage 离线消息自动忽略。
        const dealtime = date - message.sentTime < 0;
     ...
     * 处理群回执响应消息本地存储
    */
    function handleRRResMsg(message, currentUserId, connectTime, readReceiptTimeout) {
        const date = new Date(connectTime - readReceiptTimeout * 1000 * 60 * 60 * 24).getTime();
        // new Date(date).getTime() - message.sentTime < 1 逻辑判断 超过 1 天未收的 ReadReceiptRequestMessage 离线消息自动忽略。
        const dealtime = date - message.sentTime < 0;
    ...
    */
    ...
    class ChannelClient {
        constructor(_context, channelId, _isCPPMode, _readReceiptTimeout) {
            this._context = _context;
            this.channelId = channelId;
            this._isCPPMode = _isCPPMode;
            this._readReceiptTimeout = _readReceiptTimeout;
        ...
        getConversationList(callback, conversationTypes, count) {
            ...
            logger.info('getConversationList ->channelId:' + this.channelId);
            this._context.getConversationList(count, undefined, 0, 0, this.channelId).then(({ code, data }) => {
                ...
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('getConversationList ->code:' + code);
        ...
        getConversation(conversationType, targetId, callback) {
            ...
            logger.info('getConversation ->targetId:' + targetId + ',conversationType:' + conversationType);
            (() => __awaiter(this, void 0, void 0, function* () {
                const { code, data: conversation } = yield this._context.getConversation(conversationType, targetId, this.channelId);
                if (code !== engine.ErrorCode.SUCCESS) {
                    logger.warn('getConversation ->code:' + code + ',targetId:' + targetId);
        ...
        removeConversation(conversationType, targetId, callback) {
            ...
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('removeConversation ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.removeConversation(conversationType, targetId, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    if (!this._isCPPMode) {
                        LatestMessageMap.remove(conversationType, targetId, this.channelId);
                    }
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('removeConversation ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        saveTextMessageDraft(conversationType, targetId, draftText) {
            ...
            logger.info('saveTextMessageDraft ->targetId:' + targetId + ',conversationType:' + conversationType);
        ...
        getTextMessageDraft(conversationType, targetId) {
            engine.assert('conversationType', conversationType, engine.AssertRules.NUMBER, true);
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            logger.info('getTextMessageDraft ->targetId:' + targetId + ',conversationType:' + conversationType);
            const userId = this._context.getCurrentUserId();
            if (!userId) {
                return undefined;
            }
        ...
        clearTextMessageDraft(conversationType, targetId) {
            engine.assert('conversationType', conversationType, engine.AssertRules.NUMBER, true);
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            logger.info('clearTextMessageDraft ->targetId:' + targetId + ',conversationType:' + conversationType);
            const userId = this._context.getCurrentUserId();
            if (!userId) {
                return false;
            }
        ...
        getTotalUnreadCount(callback, conversationTypes, includeMuted) {
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getTotalUnreadCount ->conversationTypes:' + conversationTypes);
            this._context.getTotalUnreadCount(this.channelId, conversationTypes, includeMuted).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('getTotalUnreadCount ->code:' + code);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getUnreadCount(conversationType, targetId, callback) {
            ...
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getUnreadCount ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.getUnreadCount(conversationType, targetId, this.channelId).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, data);
                }
                else {
                    logger.warn('getUnreadCount ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        clearConversations(callback, conversationTypes) {
            logger.info('clearConversations -> conversationTypes:' + conversationTypes);
            if (this._isCPPMode) {
                this._context.clearConversations(conversationTypes, this.channelId).then(code => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('clearConversations ->code:' + code);
                        onErrorHook(callback.onError, code);
                    }
                });
                return;
        ...
        clearUnreadCount(conversationType, targetId, callback) {
            ...
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('clearUnreadCount ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.clearUnreadCount(conversationType, targetId, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, true);
                }
                else {
                    logger.warn('clearUnreadCount ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
         ...
         * @param callback
         */
        clearAllUnreadCount(callback) {
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('clearUnreadCount ->');
            this._context.clearAllUnreadCount().then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, true);
                }
                else {
                    logger.warn('clearUnreadCount ->code:' + code);
                    onErrorHook(callback.onError, code);
                }
            });
        }
         ...
         * @returns
         */
        getFirstUnreadMessage(conversationType, targetId, callback) {
            engine.assert('conversationType', conversationType, engine.AssertRules.NUMBER, true);
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getFirstUnreadMessage ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.getFirstUnreadMessage(conversationType, targetId, this.channelId).then((res) => {
                if (res.code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, res.data ? tranToV2Message(res.data) : null);
                }
                else {
                    logger.warn('getFirstUnreadMessage ->code:' + res.code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, res.code);
                }
            });
        }
        /**
        ...
        setConversationStatus(conversationType, targetId, status, callback) {
            ...
            logger.info('setConversationStatus ->targetId:' + targetId + ',status:' + status);
            ...
            this._context.setConversationStatus(conversationType, targetId, isTop, notificationStatus, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('setConversationStatus ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        sendMessage(conversationType, targetId, msg, callback, isMentioned, pushContent, pushData, options) {
            ...
            logger.info('sendMessage ->targetId:' + targetId + ',conversationType:' + conversationType);
            ...
            this._context.sendMessage(conversationType, targetId, sendOptions, callback.onBefore).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    if (!this._isCPPMode) {
                        LatestMessageMap.set(data);
                    }
                    const message = tranToV2Message(data);
                    handleRRReqMsg(message, userId, this._context.getConnectedTime(), this._readReceiptTimeout);
                    onSuccessHook(callback.onSuccess, message);
                }
                else {
                    logger.warn('sendMessage ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code, tranToV2Message({
                        ...
                        isStatusMessage,
                        receivedStatus: engine.ReceivedStatus.UNREAD,
                        messageId: data === null || data === void 0 ? void 0 : data.messageId,
                        sentStatus: SentStatus$1.FAILED
                    }));
                }
            });
        }
        ...
        sendRecallMessage(message, callback, options) {
            ...
            logger.info('sendRecallMessage ->targetId:' + targetId + ',conversationType:' + conversationType + ',messageUId:' + messageUId);
            ...
            this._context.recallMessage(conversationType, targetId, messageUId, sentTime, recallOptions).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('sendRecallMessage ->code:' + code + ',targetId:' + targetId + ',messageUId:' + messageUId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        sendTypingStatusMessage(conversationType, targetId, typingContentType, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('sendTypingStatusMessage ->targetId:' + targetId + ',conversationType:' + conversationType);
            const sendOptions = {
            ...
            this._context.sendMessage(conversationType, targetId, sendOptions).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('sendTypingStatusMessage ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        sendReceiptResponse(conversationType, targetId, callback) {
            logger.info('sendReceiptResponse ->targetId:' + targetId + ',conversationType:' + conversationType);
            const userId = this._context.getCurrentUserId();
            ...
            if (valObj) {
                ...
                const itvId = setInterval(() => {
                    ...
                    this.sendMessage(conversationType, targetId, respMsg, {
                        ...
                        onError: (code) => {
                            logger.warn('sendReceiptResponse ->code:' + code + ',targetId:' + targetId);
                            onErrorHook(callback.onError, code);
                        }
                    });
                }, 200);
         ...
         * @param callback
         */
        sendReadReceiptMessage(messageUIds, targetId, callback) {
            engine.assert('messageUIds', messageUIds, engine.AssertRules.ARRAY, true);
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            logger.info('sendReadReceiptMessage ->targetId:' + targetId + ',messageUIds:' + messageUIds);
            for (const uid of messageUIds) {
                engine.assert('messageUId', uid, engine.AssertRules.STRING);
            }
            this._context.sendReadReceiptMessage(targetId, messageUIds, this.channelId).then(({ code }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess();
                }
                else {
                    logger.warn('sendReadReceiptMessage ->code:' + code + ',targetId:' + targetId + ',messageUIds:' + messageUIds);
                    callback.onError(code);
                }
            }).catch(reason => {
                logger.warn('sendReadReceiptMessage ->code:' + reason + ',targetId:' + targetId + ',messageUIds:' + messageUIds);
         ...
         * @param callback
         */
        getMessageReader(messageUId, targetId, callback) {
            engine.assert('messageUId', messageUId, engine.AssertRules.STRING, true);
            engine.assert('targetId', targetId, engine.AssertRules.STRING, true);
            logger.info('getMessageReader ->targetId:' + targetId + ',messageUId:' + messageUId);
            this._context.getMessageReader(targetId, messageUId, this.channelId).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(data);
                }
                else {
                    logger.warn('getMessageReader ->code:' + code + ',targetId:' + targetId + ',messageUId:' + messageUId);
                    callback.onError(code);
                }
            }).catch(reason => {
                logger.warn('getMessageReader ->code:' + reason + ',targetId:' + targetId + ',messageUId:' + messageUId);
                callback.onError(reason);
            });
        }
        /**
        ...
        updateMessageExpansion(expansionDic, message, callback) {
            ...
            logger.info('updateMessageExpansion ->targetId:' + targetId + ',messageUId:' + messageUId + ',conversationType:' + conversationType);
            this._context.sendExpansionMessage({
                conversationType, targetId, messageUId, canIncludeExpansion, originExpansion, expansion: expansionDic, channelId: this.channelId
            }).then(({ code }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('updateMessageExpansion ->code:' + code + ',targetId:' + targetId + ',messageUId:' + messageUId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        removeMessageExpansionForKey(keys, message, callback) {
            ...
            logger.info('removeMessageExpansionForKey ->targetId:' + targetId + ',messageUId:' + messageUId + ',conversationType:' + conversationType);
            this._context.sendExpansionMessage({
                conversationType, targetId, messageUId, canIncludeExpansion, keys, channelId: this.channelId
            }).then(({ code }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('removeMessageExpansionForKey ->code:' + code + ',targetId:' + targetId + ',messageUId:' + messageUId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getHistoryMessages(conversationType, targetId, timestamp, count, callback, objectName, order) {
            ...
            logger.info('getHistoryMessages ->targetId:' + targetId + ',conversationType:' + conversationType + ',timestamp:' + timestamp);
            this._context.getHistoryMessage(conversationType, targetId, timestamp, count, order, this.channelId, objectName).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('getHistoryMessages ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        deleteRemoteMessages(conversationType, targetId, messages, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('deleteRemoteMessages ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.deleteRemoteMessage(conversationType, targetId, messages, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    if (!this._isCPPMode) {
                        const lastMessage = LatestMessageMap.get(conversationType, targetId, this.channelId);
                        if (lastMessage) {
                            messages.forEach((item) => {
                                if (lastMessage.messageUId === item.messageUId) {
                                    LatestMessageMap.remove(conversationType, targetId, this.channelId);
                                }
                            });
                        }
                    ...
                    logger.warn('deleteRemoteMessages ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        clearRemoteHistoryMessages(param, callback) {
            ...
            logger.info('clearRemoteHistoryMessages ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.deleteRemoteMessageByTimestamp(conversationType, targetId, timestamp, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('clearRemoteHistoryMessages ->code:' + code);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        insertMessage(conversationType, targetId, content, callback, options = {}) {
            ...
            logger.info('insertMessage ->targetId:' + targetId + ',conversationType:' + conversationType);
            ...
            this._context.insertMessage(conversationType, targetId, insertOptions).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('insertMessage ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        deleteLocalMessagesByTimestamp(conversationType, targetId, timestamp, cleanSpace, callback) {
            logger.info('deleteLocalMessagesByTimestamp ->targetId:' + targetId + ',conversationType:' + conversationType + ',timestamp:' + timestamp);
            this._context.deleteMessagesByTimestamp(conversationType, targetId, timestamp, cleanSpace, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, true);
                }
                else {
                    logger.warn('deleteLocalMessagesByTimestamp ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        getRemoteHistoryMessages(conversationType, targetId, timestamp, count, callback, options) {
            logger.info('getRemoteHistoryMessages ->targetId:' + targetId + ',conversationType:' + conversationType);
            ...
            this._context.getRemoteHistoryMessages(conversationType, targetId, timestamp, count, order, this.channelId).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('getRemoteHistoryMessages ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        clearMessages(conversationType, targetId, callback) {
            logger.info('clearMessages ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.clearMessages(conversationType, targetId, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('clearMessages ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        searchMessageByContent(conversationType, targetId, keyword, timestamp, count, total, callback) {
            logger.info('setConversationStatus ->targetId:' + targetId + ',conversationType:' + conversationType + ',keyword:' + keyword);
            this._context.searchMessageByContent(conversationType, targetId, keyword, timestamp, count, total, this.channelId).then(({ code, data }) => {
                ...
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('searchMessageByContent ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        getUnreadMentionedMessages(conversationType, targetId) {
            logger.info('getUnreadMentionedMessages ->targetId:' + targetId + ',conversationType:' + conversationType);
        ...
        */
        clearUnreadCountByTimestamp(conversationType, targetId, timestamp, callback) {
            logger.info('clearUnreadCountByTimestamp ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.clearUnreadCountByTimestamp(conversationType, targetId, timestamp, this.channelId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, true);
                }
                else {
                    logger.warn('clearUnreadCountByTimestamp ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        */
        getConversationNotificationStatus(conversationType, targetId, callback) {
            logger.info('getConversationNotificationStatus ->targetId:' + targetId + ',conversationType:' + conversationType);
            this._context.getConversationNotificationStatus(conversationType, targetId, this.channelId).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, data);
                }
                else {
                    logger.warn('getConversationNotificationStatus ->code:' + code + ',targetId:' + targetId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
    ...
    class IMClient {
        constructor(_context, _options) {
            ...
            this._defaultChannelClient = new ChannelClient(_context, '', this._isCPPMode, _options.readReceiptTimeout);
        }
        /**
         * 协议栈方法校验
         */
        ...
        */
        getChannel(channelId) {
            logger.info('getChannel ->channelId:' + channelId);
            if (!this._isCPPMode) {
            ...
            this._channelClient[channelId] = new ChannelClient(this._context, channelId, this._isCPPMode, this._options.readReceiptTimeout);
            return this._channelClient[channelId];
        }
        /**
        ...
        */
        deleteChannels(channelIds) {
            ...
            logger.info('deleteChannels ->channelIds:' + channelIds);
            this.assertCPPMode(() => {
        ...
        */
         ...
         */
        clearAllUnreadCount(callback) {
            this._defaultChannelClient.clearAllUnreadCount(callback);
        }
        /**
         * 设置会话状态：是否置顶、是否免打扰
         * @param conversationType
         ...
         */
        sendReadReceiptMessage(messageUIds, targetId, callback) {
            return this._defaultChannelClient.sendReadReceiptMessage(messageUIds, targetId, callback);
        }
        /**
         * 获取群已读列表
         * @param messageUIds
         ...
         */
        getMessageReader(messageUId, targetId, callback) {
            this._defaultChannelClient.getMessageReader(messageUId, targetId, callback);
        }
        /**
         * 更新消息扩展
         * @param expansionDic 要更新的消息扩展信息键值对
        ...
        */
        updateMessageExpansion(expansionDic, message, callback) {
            ...
            //   }
            // })
            this._defaultChannelClient.updateMessageExpansion(expansionDic, message, callback);
        }
        /**
         * 删除消息扩展属性
        * @param keys 消息扩展信息中待删除的 key 的列表
        ...
        */
        removeMessageExpansionForKey(keys, message, callback) {
            ...
            //   }
            // })
            this._defaultChannelClient.removeMessageExpansionForKey(keys, message, callback);
        }
        /**
         * 从服务端拉取指定会话的历史消息
         * @param conversationType 会话类型
        ...
        joinChatRoom(chatRoomId, count, callback) {
            ...
            engine.assert('count', count, engine.AssertRules.NUMBER, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('joinChatRoom ->chatRoomId:' + chatRoomId);
            this._context.joinChatroom(chatRoomId, count).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('joinChatRoom ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        quitChatRoom(chatRoomId, callback) {
            engine.assert('chatRoomId', chatRoomId, engine.AssertRules.STRING, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('quitChatRoom ->chatRoomId:' + chatRoomId);
            this._context.quitChatroom(chatRoomId).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('quitChatRoom ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getChatRoomInfo(chatRoomId, count, order, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getChatRoomInfo ->chatRoomId:' + chatRoomId);
            this._context.getChatroomInfo(chatRoomId, count, order).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('getChatRoomInfo ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        setChatroomEntry(chatRoomId, chatroomEntry, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('setChatroomEntry ->chatRoomId:' + chatRoomId);
            this._context.setChatroomEntry(chatRoomId, chatroomEntry).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('setChatroomEntry ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        forceSetChatroomEntry(chatRoomId, chatroomEntry, callback) {
            ...
            engine.assert('chatroomEntry', chatroomEntry, engine.AssertRules.OBJECT, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('forceSetChatroomEntry ->chatRoomId:' + chatRoomId);
            this._context.forceSetChatroomEntry(chatRoomId, chatroomEntry).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('forceSetChatroomEntry ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        removeChatroomEntry(chatRoomId, chatroomEntry, callback) {
            ...
            engine.assert('chatroomEntry', chatroomEntry, engine.AssertRules.OBJECT, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('removeChatroomEntry ->chatRoomId:' + chatRoomId);
            this._context.removeChatroomEntry(chatRoomId, chatroomEntry).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('removeChatroomEntry ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        forceRemoveChatroomEntry(chatRoomId, chatroomEntry, callback) {
            ...
            engine.assert('chatroomEntry', chatroomEntry, engine.AssertRules.OBJECT, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('forceRemoveChatroomEntry ->chatRoomId:' + chatRoomId);
            this._context.forceRemoveChatroomEntry(chatRoomId, chatroomEntry).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess);
                }
                else {
                    logger.warn('forceRemoveChatroomEntry ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getChatroomEntry(chatRoomId, key, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getChatroomEntry ->chatRoomId:' + chatRoomId + ',key:' + key);
            this._context.getChatroomEntry(chatRoomId, key).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, data || '');
                }
                else {
                    logger.warn('getChatroomEntry ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getAllChatroomEntries(chatRoomId, callback) {
            engine.assert('chatRoomId', chatRoomId, engine.AssertRules.STRING, true);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getAllChatroomEntries ->chatRoomId:' + chatRoomId);
            this._context.getAllChatroomEntries(chatRoomId).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, data);
                }
                else {
                    logger.warn('getAllChatroomEntries ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getChatRoomHistoryMessages(chatRoomId, count, order, callback, timestamp = 0) {
            ...
            logger.info('getChatRoomHistoryMessages ->chatRoomId:' + chatRoomId);
            this._context.getChatRoomHistoryMessages(chatRoomId, count, order, timestamp).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('getChatRoomHistoryMessages ->code:' + code + ',chatRoomId:' + chatRoomId);
                    onErrorHook(callback.onError, code);
                }
            });
        }
        ...
        getFileToken(fileType, callback, fileName, httpMethod, queryString) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getFileToken ->fileType:' + fileType + ',fileName:' + fileName + ',queryString:' + queryString);
        ...
        getFileUrl(fileType, fileName, saveName, callback, uploadRes, serverType) {
            ...
            logger.info('getFileUrl ->fileType:' + fileType + ',fileName:' + fileName);
        ...
        */
        createTag(tag, callback) {
            ...
            this._context.createTag(tag).then(({ code }) => {
                // code === ErrorCode.SUCCESS ? callback.onSuccess() : callback.onError(code)
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess();
                }
                else {
                ...
                logger.warn('createTag ->code:' + reason + ',tagId:' + tag.tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        removeTag(tagId, callback) {
            ...
            this._context.removeTag(tagId).then(({ code }) => {
                ...
                logger.warn('removeTag ->code:' + reason + ',tagId:' + tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        updateTag(tag, callback) {
            ...
            this._context.updateTag(tag).then(({ code }) => {
                ...
                logger.warn('updateTag ->reason:' + reason + ',tagId:' + tag.tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        getTagList(callback) {
            ...
            this._context.getTagList().then(({ code, data }) => {
                ...
                logger.warn('getTagList ->reason:' + reason);
                callback.onError(reason);
            });
        }
        /**
        ...
        getTagsForConversation(conversation, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getTagsForConversation ->targetId:' + conversation.targetId + ',conversationType:' + conversation.type);
            this._context.getTagsForConversation(conversation).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(data || []);
                }
                else {
                    logger.warn('getTagsForConversation ->code:' + code);
                    callback.onError(code);
                }
            }).catch(reason => {
                logger.warn('getTagsForConversation ->reason:' + reason);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        addTagForConversations(tagId, conversations, callback) {
            ...
            this._context.addTagForConversations(tagId, conversations).then(({ code, data }) => {
                ...
                logger.warn('addTagForConversations ->reason:' + reason + ',tagId:' + tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        removeTagForConversations(tagId, conversations, callback) {
            ...
            this._context.removeTagForConversations(tagId, conversations).then(({ code, data }) => {
                ...
                logger.warn('removeTagForConversations ->reason:' + reason + ',tagId:' + tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        removeTagsForConversation(conversation, tagIds, callback) {
            ...
            logger.info('removeTagsForConversation ->tagIds:' + tagIds + ',targetId:' + conversation.targetId + ',type:' + conversation.type);
            this._context.removeTagsForConversation(conversation, tagIds).then(({ code, data }) => {
                ...
                logger.warn('removeTagsForConversation ->reason:' + reason + ',tagIds:' + tagIds);
                callback.onError(reason);
            });
        }
        /**
        ...
        */
        getConversationListByTag(tagId, count, startTime, callback) {
            ...
            this._context.getConversationListByTag(tagId, startTime, count).then(({ code, data }) => {
                ...
                logger.warn('getConversationListByTag ->reason:' + reason + ',tagId:' + tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        getUnreadCountByTag(tagId, containMuted, callback) {
            ...
            this._context.getUnreadCountByTag(tagId, containMuted).then(({ code, data }) => {
                ...
                logger.warn('getUnreadCountByTag ->reason:' + reason + ',tagId:' + tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        setConversationStatusInTag(tagId, conversation, status, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('setConversationStatusInTag ->tagId:' + tagId + ',targetId:' + conversation.targetId + ',type' + conversation.type);
            this._context.setConversationStatusInTag(tagId, conversation, status).then(({ code, data }) => {
                ...
                logger.warn('setConversationStatusInTag ->reason:' + reason + ',tagId:' + tagId);
                callback.onError(reason);
            });
        }
        /**
        ...
        callExtra(method, callback, ...args) {
            logger.info('callExtra ->method:' + method);
            this._context.callExtra(method, ...args).then((res) => {
                ...
                logger.warn('callExtra ->code:' + code);
        ...
        */
        hasRemoteUnreadMessages(token, callback) {
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('hasRemoteUnreadMessages ->token:' + token);
            // 与旧 V2 一致
            this.assertCPPMode(() => {
                onSuccessHook(callback.onSuccess, false);
        ...
        */
        setUserStatusListener(config, listener) {
            logger.info('setUserStatusListener ->userIds:' + config.userIds);
            this.assertCPPMode(() => {
        ...
        */
        setUserStatus(status, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('setUserStatus ->status:' + status);
            this.assertCPPMode(() => {
                this._context.setUserStatus(status).then((code) => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('setUserStatus ->code:' + code);
                        onErrorHook(callback.onError, code);
                    }
                });
        ...
        */
        getUserStatus(userId, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getUserStatus ->userId:' + userId);
            this.assertCPPMode(() => {
                this._context.getUserStatus(userId).then(({ code, data }) => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('getUserStatus ->code:' + code + ',useerId:' + userId);
                        onErrorHook(callback.onError, code);
                    }
                });
        ...
        */
        addToBlacklist(userId, callback) {
            engine.assert('userId', userId, engine.AssertRules.STRING);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('addToBlacklist ->userId:' + userId);
            this.assertCPPMode(() => {
                this._context.addToBlacklist(userId).then((code) => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('addToBlacklist ->code:' + code + ',useerId:' + userId);
                        onErrorHook(callback.onError, code);
                    }
                });
        ...
        */
        removeFromBlacklist(userId, callback) {
            engine.assert('userId', userId, engine.AssertRules.STRING);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('removeFromBlacklist ->userId:' + userId);
            this.assertCPPMode(() => {
                this._context.removeFromBlacklist(userId).then(code => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('removeFromBlacklist ->code:' + code + ',useerId:' + userId);
                        onErrorHook(callback.onError, code);
                    }
                });
            ...
            this.assertCPPMode(() => {
                this._context.getBlacklist().then(({ code, data }) => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('getBlacklist ->code:' + code);
                        onErrorHook(callback.onError, code);
                    }
                });
            }, 'getBlacklist', callback);
        ...
        */
        getBlacklistStatus(userId, callback) {
            engine.assert('userId', userId, engine.AssertRules.STRING);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('getBlacklistStatus ->userId:' + userId);
            this.assertCPPMode(() => {
                this._context.getBlacklistStatus(userId).then(({ code, data }) => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('getBlacklistStatus ->code:' + code + ',userId:' + userId);
                        onErrorHook(callback.onError, code);
                    }
                });
        ...
        */
        insertMessage(conversationType, targetId, content, callback, options = {}) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('insertMessage ->targetId:' + targetId + ',conversationType:' + conversationType + ',senderUserId:' + content.senderUserId);
            this.assertCPPMode(() => {
        ...
        */
        deleteLocalMessages(_, __, messageIds, callback) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            logger.info('deleteLocalMessages ->messageIds:' + messageIds);
            this.assertCPPMode(() => {
                this._context.deleteMessages(messageIds).then(code => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('deleteLocalMessages ->code:' + code + ',messageIds:' + messageIds);
                        onErrorHook(callback.onError, code);
                    }
                });
        ...
        */
        setMessageSentStatus(messageId, sentStatus, callback) {
            ...
            logger.info('setMessageSentStatus ->messageId:' + messageId + ',sentStatus:' + sentStatus);
            this.assertCPPMode(() => {
                this._context.setMessageSentStatus(messageId, sentStatus).then(code => {
                    if (code === engine.ErrorCode.SUCCESS) {
                        ...
                        logger.warn('setMessageSentStatus ->code:' + code + ',messageId:' + messageId);
                        onErrorHook(callback.onError, code);
                    }
                });
        ...
        */
        setMessageContent(messageId, content, objectName) {
            ...
            logger.info('setMessageContent ->messageId:' + messageId + ',objectName:' + objectName);
            this.assertCPPMode(() => {
        ...
        */
        setMessageSearchField(messageId, content, searchFiles) {
            ...
            logger.info('setMessageSearchField ->messageId:' + messageId + ',searchFiles:' + searchFiles);
            this.assertCPPMode(() => {
        ...
        */
         ...
         */
        getFirstUnreadMessage(conversationType, targetId, callback) {
            return this._defaultChannelClient.getFirstUnreadMessage(conversationType, targetId, callback);
        }
        /**
         * 获取会话免打扰状态
         * @param conversationType 会话类型
        ...
        */
        ...
        getRTCUserInfoList(room, callback) {
            logger.info('getRTCUserInfoList ->roomId:' + room.id);
            this._context.getRTCUserInfoList(room.id).then(({ code, data }) => {
                ...
                logger.warn('getRTCUserInfoList ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('getRTCUserInfoList ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        getRTCUserList(room, callback) {
            logger.info('getRTCUserList ->roomId:' + room.id);
            this._context.getRTCUserList(room.id).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(data);
                    return;
                }
                logger.warn('getRTCUserList ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('getRTCUserList ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        setRTCUserInfo(room, info, callback) {
            logger.info('setRTCUserInfo ->roomId:' + room.id + ',info:' + JSON.stringify(info || {}));
            this._context.setRTCUserInfo(room.id, info.key, info.value).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('setRTCUserInfo ->code:' + code + ',roomId:' + room.id + ',key:' + info.key + ',value:' + info.value);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('setRTCUserInfo ->code:' + error + ',roomId:' + room.id + ',key:' + info.key + ',value:' + info.value);
                callback.onError(error);
            });
        }
        removeRTCUserInfo(room, info, callback) {
            logger.info('removeRTCUserInfo ->roomId:' + room.id + 'keys:' + info.keys);
            this._context.removeRTCUserInfo(room.id, info.keys).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('removeRTCUserInfo ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('removeRTCUserInfo ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        getRTCRoomInfo(room, callback) {
            logger.info('getRTCRoomInfo ->roomId:' + room.id);
            this._context.getRTCRoomInfo(room.id).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(data);
                    return;
                }
                logger.warn('getRTCRoomInfo ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('getRTCRoomInfo ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        // RTC SDK 未使用
        ...
        joinRTCRoom(room, callback) {
            logger.info('joinRTCRoom ->roomId:' + room.id);
            ...
            this._context.joinRTCRoom(room.id, mode).then(({ code, data }) => {
                ...
                logger.warn('joinRTCRoom ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('joinRTCRoom ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        quitRTCRoom(room, callback) {
            logger.info('quitRTCRoom ->roomId:' + room.id);
            this._context.quitRTCRoom(room.id).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('quitRTCRoom ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('quitRTCRoom ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        RTCPing(room, callback) {
            logger.info('RTCPing ->roomId:' + room.id);
            const mode = room.mode || 0;
            this._context.rtcPing(room.id, mode).then(code => {
                ...
                logger.warn('RTCPing ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('RTCPing ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        setRTCData(roomId, key, value, isInner, apiType, callback, message) {
            logger.info('setRTCData ->roomId:' + roomId + ',key:' + key);
            this._context.setRTCData(roomId, key, value, isInner, apiType, message).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('setRTCData ->code:' + code + ',roomId:' + roomId);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('setRTCData ->error:' + error + ',roomId:' + roomId);
                callback.onError(error);
            });
        }
        getRTCData(roomId, keys, isInner, apiType, callback) {
            logger.info('getRTCData ->roomId:' + roomId + ',keys:' + keys);
            this._context.getRTCData(roomId, keys, isInner, apiType).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(data);
                    return;
                }
                logger.warn('getRTCData ->code:' + code + ',roomId:' + roomId);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('setRTCUserInfo ->error:' + error + ',roomId:' + roomId);
                callback.onError(error);
            });
        }
        removeRTCData(roomId, keys, isInner, apiType, callback, message) {
            logger.info('removeRTCData ->roomId:' + roomId + ',keys:' + keys);
            this._context.removeRTCData(roomId, keys, isInner, apiType, message).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('removeRTCData ->code:' + code + ',roomId:' + roomId);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('removeRTCData ->error:' + error + ',roomId:' + roomId);
                callback.onError(error);
            });
        }
        ...
        setRTCUserTotalRes(roomId, message, valueInfo, objectName, callback) {
            logger.info('setRTCUserTotalRes ->roomId:' + roomId);
            this._context.setRTCTotalRes(roomId, message, valueInfo, objectName).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('setRTCUserTotalRes ->code:' + code + ',roomId:' + roomId);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('setRTCUserTotalRes ->error:' + error + ',roomId:' + roomId);
                callback.onError(error);
            });
        }
        ...
        getRTCToken(room, callback) {
            logger.info('getRTCToken ->roomId:' + room.id);
            this._context.getRTCToken(room.id, room.mode, room.broadcastType).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(data);
                    return;
                }
                logger.warn('getRTCToken ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('getRTCToken ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
        setRTCState(room, content, callback) {
            logger.info('setRTCState ->roomId:' + room.id);
            this._context.setRTCState(room.id, content.report).then(code => {
                if (code === engine.ErrorCode.SUCCESS) {
                    callback.onSuccess(true);
                    return;
                }
                logger.warn('setRTCState ->code:' + code + ',roomId:' + room.id);
                callback.onError(code);
            }).catch((error) => {
                logger.warn('setRTCState ->error:' + error + ',roomId:' + room.id);
                callback.onError(error);
            });
        }
    }
    ...
    var RongIMClient = {
        ...
        init(appkey, _, options = {}) {
            engine.assert('appkey', appkey, engine.AssertRules.STRING, true);
            logger.setLogLevel(options.logLevel);
            logger.setLogStdout(options.logStdout);
            logger.info(`RongIMLib Version: ${"2.9.8-enterprise.2"}, Commit: ${"509020a04ffdd66eac24a9ccb9e26b146ee66af0"},appkey:` + appkey);
            let connectionType = options === null || options === void 0 ? void 0 : options.connectionType;
            if (!connectionType) {
            ...
            context = engine.APIContext.init(runtime, {
                appkey,
                apiVersion: "2.9.8-enterprise.2",
                navigators: options.navi ? [options.navi] : [],
                miniCMPProxy: [],
                connectionType,
                logLevel: options.logLevel,
                logStdout: options.logStdout,
                typingExpireTime: options.typingExpireTime,
                indexDBSwitch: options.indexDBSwitch,
                checkCA: options.checkCA
            });
            readReceiptTimeout = Math.min(15, Math.max(options.readReceiptTimeout || 1, 1));
        ...
        setOnReceiveMessageListener(listener) {
            context.assignWatcher({
                message: (message, leftCount, hasMore) => {
                    try {
                        let v2Message = tranToV2Message(message);
                        const currentUserId = context.getCurrentUserId();
                        const connectTime = context.getConnectedTime();
                        // 处理收到的群回执请求消息
                        handleRRReqMsg(v2Message, currentUserId, connectTime, readReceiptTimeout);
                        // 处理收到的群回执响应消息
                        v2Message = handleRRResMsg(v2Message, currentUserId, connectTime, readReceiptTimeout);
                        // 浏览器环境更新最后一条消息的 Map
                        if (!engine.usingCppEngine()) {
                            LatestMessageMap.set(message);
                        }
                        listener.onReceived(v2Message, undefined, hasMore);
                    }
                    catch (err) {
                        logger.error('setOnReceiveMessageListener ->error:' + err);
                    }
                }
            });
        },
            ...
            context.assignWatcher({
                conversationState: (conversations) => {
                    try {
                        ...
                        logger.error('setConversationStatusListener ->error:' + err);
                    }
                }
            });
        },
        ...
        */
            ...
            context.assignWatcher({
                expansion: (info) => {
                    try {
                        ...
                        logger.error('setMessageExpansionListener ->error:' + err);
                    }
                }
            });
        },
         ...
         * 用于拉取完毕监听
         */
        setPullOffLineFinished(listener) {
            context.assignWatcher({
                pullFinished: () => {
                    listener.onFinished();
                }
         ...
         * typing监听
         */
        setTypingStatusListener(listenner) {
            context.assignWatcher({
                typingState: (info) => {
                    listenner.onChanged(info);
                }
            });
        },
        /**
        ...
        connect(token, callback) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (res.code === engine.ErrorCode.SUCCESS) {
                    ...
                    // 清理存储，包括receive和send
                    const date = new Date(context.getConnectedTime() - readReceiptTimeout * 1000 * 60 * 60 * 24).getTime();
                    v2Storage.getKeys().forEach(key => {
                        if (/SENT$/.test(key)) {
                            const dealtime = v2Storage.get(key).dealtime;
                            if (dealtime && date - dealtime > 0) {
                                v2Storage.remove(key);
                            }
                        }
                        else if (/RECEIVED$/.test(key)) {
                            const list = v2Storage.get(key);
                            const originLength = Object.keys(list).length;
                            Object.keys(list).forEach(k => {
                                const dealtime = list[k].dealtime;
                                if (dealtime && date - dealtime > 0) {
                                    delete list[k];
                                }
                            });
                            if (Object.keys(list).length !== originLength) {
                                if (list.length === 0) {
                                    v2Storage.remove(key);
                                }
                                else {
                                    v2Storage.set(key, list);
                                }
                            }
                        }
                    });
                    ...
                    logger.warn('connect ->code:' + res.code + ',token:' + token);
        ...
        reconnect(callback, options) {
            context.reconnect().then(res => {
                if (res.code === engine.ErrorCode.SUCCESS) {
                    ...
                    logger.warn('reconnect ->code:' + res.code);
                    callback.onError(res.code);
                }
        ...
        */
         ...
         * @returns Logger
         */
        createLogger(tag, type) {
            if (/^(RC)/.test(tag)) {
                logger.error('Tag error. Tags that start with RC are used internally by the SDK !');
                return null;
            }
            if (!['IM', 'RTC'].includes(type)) {
                logger.error('The parameter type must be one of IM, or RTC !');
                return null;
            }
            return new engine.Logger(tag, type, 'A');
        },
        /**
         * RTC Lib 内部使用消息监听器
        */
        messageWatch(watcher) {
            rtcInnerMsgWatcher.push((message) => {
                logger.info('messageWatch ->message:' + JSON.stringify(message || {}));
                try {
                    watcher(message);
                    this._voipProvider.onReceived && this._voipProvider.onReceived(message);
                }
                catch (err) {
                    logger.error('messageWatch ->error:' + err);
                }
            });
        ...
        */
        statusWatch(watcher) {
            rtcInnerStatusWatcher.push((status) => {
                logger.info('statusWatch ->status:' + status);
                try {
                    watcher(status);
                }
                catch (err) {
                    logger.error('statusWatch ->error:' + err);
                }
            });
        },
        /**
