/*
 * RCEngine - v4.4.9-enterprise-alpha.2
 * CommitId - c87f201866ec8889a19139c40565479e7002c10d
 * Mon Nov 29 2021 09:54:12 GMT+0800 (GMT+08:00)
...
`;
    ...
    */
    ...
    (function (Topic) {
        ...
        Topic[Topic["addSeTag"] = 72] = "addSeTag";
        Topic[Topic["delSeTag"] = 73] = "delSeTag";
        Topic[Topic["addTag"] = 74] = "addTag";
        Topic[Topic["delTag"] = 75] = "delTag";
        Topic[Topic["disTag"] = 76] = "disTag";
        Topic[Topic["reportsdk"] = 77] = "reportsdk"; // 上报融云SDK信息
    })(Topic || (Topic = {}));
    var Topic$1 = Topic;

    const validHosts = (hosts, protocol, runtime, callback) => __awaiter(void 0, void 0, void 0, function* () {
        let num = 0;
        ...
        connect(appkey, token, hosts, protocol, apiVersion) {
            return __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve) => {
                    ...
                    // 发起 ping 请求
                    validHosts(hosts, protocol, this._runtime, (error, { code, finished, host }) => {
                        // error 是为了解决这个函数内部 eslint 报错，没其他作用
                        if (error)
                            return;
    ...
    */
    ...
    class APIContext {
        constructor(_runtime, options) {
             ...
             */
            this.coreVersion = "4.4.9-enterprise-alpha.2";
            this._versionInfo = {};
            this._typingInfo = {};
            /**
        ...
        static init(runtime, options) {
            ...
            logger.warn('RCEngine Commit:', "c87f201866ec8889a19139c40565479e7002c10d");
     ...
     * engine 版本号
     */
    const version = "4.4.9-enterprise-alpha.2";
...
/*
 * RongIMLib - v2.9.9-enterprise-alpha.2
 * CommitId - d6bd0e0d170bf22663fe4a5f52524f60a2a98cbf
 * Mon Nov 29 2021 09:54:41 GMT+0800 (GMT+08:00)
 * ©2020 RongCloud, Inc. All rights reserved.
 */
(function (global, factory) {
    ...
    */
    ...
    var RongIMClient = {
        ...
        init(appkey, _, options = {}) {
            ...
            logger.setLogLevel(options.logLevel);
            logger.setLogStdout(options.logStdout);
            logger.info(`RongIMLib Version: ${"2.9.9-enterprise-alpha.2"}, Commit: ${"d6bd0e0d170bf22663fe4a5f52524f60a2a98cbf"},appkey:` + appkey);
            ...
            context = engine.APIContext.init(runtime, {
                appkey,
                apiVersion: "2.9.9-enterprise-alpha.2",
